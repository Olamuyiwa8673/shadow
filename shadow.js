...
const { rentfromshadow, conns } = require('./RentBot')
...
const scp2 = require('./lib/scrape/scraper2')
const scp3 = require('./lib/scrape/scraper3')
const { InstaMp4 } = require('./lib/scrape/InstaMp4')
const { IgImg } = require('./lib/scrape/IgImg')
const { Fb } = require('./lib/scrape/Fb')
const { Twitter } = require('./lib/scrape/Twitter')
...
const textpro2 = require('./lib/scrape/textpro2')
const photooxy = require('./lib/scrape/photooxy')
const yts = require('./lib/scrape/yt-search/dist/yt-search')
...
const verifieduser = JSON.parse(fs.readFileSync('./lib/database/user.json'))
const VoiceNote = JSON.parse(fs.readFileSync('./Assets/Media2/database/xeonvn.json'))
const StickerS = JSON.parse(fs.readFileSync('./Assets/Media2/database/xeonsticker.json'))
const ImageS = JSON.parse(fs.readFileSync('./Assets/Media2/database/xeonimage.json'))
const VideoX = JSON.parse(fs.readFileSync('./Assets/Media2/database/xeonvideo.json'))
const BadX = JSON.parse(fs.readFileSync('./lib/database/bad.json'))
...
let ntwame = JSON.parse(fs.readFileSync('./lib/database/antiwame.json'))
let ntlinkgc =JSON.parse(fs.readFileSync('./lib/database/antilinkgc.json'))
let ntilinkall =JSON.parse(fs.readFileSync('./lib/database/antilinkall.json'))
let ntilinktwt =JSON.parse(fs.readFileSync('./lib/database/antilinktwitter.json'))
let ntilinktt =JSON.parse(fs.readFileSync('./lib/database/antilinktiktok.json'))
let ntilinktg =JSON.parse(fs.readFileSync('./lib/database/antilinktelegram.json'))
let ntilinkfb =JSON.parse(fs.readFileSync('./lib/database/antilinkfacebook.json'))
let ntilinkig =JSON.parse(fs.readFileSync('./lib/database/antilinkinstagram.json'))
let ntilinkytch =JSON.parse(fs.readFileSync('./lib/database/antilinkytchannel.json'))
let ntilinkytvid =JSON.parse(fs.readFileSync('./lib/database/antilinkytvideo.json'))
...
module.exports = ShadowBotInc = async (ShadowBotInc, m, chatUpdate, store) => {
try {
        ...
        const botNumber = await ShadowBotInc.decodeJid(ShadowBotInc.user.id)
        const ShadowTheCreator = [botNumber, ...owner].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
        const ShadowTheDeveloper = m.sender == botNumber ? true : false
    	...
    	const banUser = await ShadowBotInc.fetchBlocklist()
        ...
        //theme sticker reply
     /*   const XeonStickWait = () => {
        let XeonStikRep = fs.readFileSync('./Assets/Media2/theme/sticker_reply/wait.webp')
        ShadowBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickAdmin = () => {
        let XeonStikRep = fs.readFileSync('./Assets/Media2/theme/sticker_reply/admin.webp')
        ShadowBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickBotAdmin = () => {
        let XeonStikRep = fs.readFileSync('./Assets/Media2/theme/sticker_reply/botadmin.webp')
        ShadowBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickOwner = () => {
        let XeonStikRep = fs.readFileSync('./Assets/Media2/theme/sticker_reply/owner.webp')
        ShadowBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickGroup = () => {
        let XeonStikRep = fs.readFileSync('./Assets/Media2/theme/sticker_reply/group.webp')
        ShadowBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickPrivate = () => {
        let XeonStikRep = fs.readFileSync('./Assets/Media2/theme/sticker_reply/private.webp')
        ShadowBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        } */
                   
        //TIME
        const stime = moment.tz('Africa/Lagos').format('HH:mm:ss')
        const xdate = moment.tz('Africa/Lagos').format('DD/MM/YYYY')
        const time2 = moment().tz('Africa/Lagos').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
var shadowytimewisher = `Oyasumi nasai 🏙`
 }
 if(time2 < "19:00:00"){
var shadowytimewisher = `Konbanwa 🌇`
 }
 if(time2 < "18:00:00"){
var shadowytimewisher = `Konbanwa 🌇`
 }
 if(time2 < "15:00:00"){
var shadowytimewisher = `Konnichiwa 🏞`
 }
 if(time2 < "11:00:00"){
var shadowytimewisher = `Ohayou gozaimasu 🌅`
 }
 if(time2 < "05:00:00"){
var shadowytimewisher = `Ohayou gozaimasu 🌅`
 } 
		...
		if (isEval && senderNumber == "916909137213") {
			...
			try {
				...
				await ShadowBotInc.sendMessage(from, { text: evaled }, { quoted: m })
			} catch (e) {
				ShadowBotInc.sendMessage(from, { text: String(e) }, { quoted: m })
			}
		}
try {
...
if (!ShadowBotInc.public) {
if (!m.key.fromMe) return
}

//chat counter (console log)
        if (m.message && m.isGroup) {
            ShadowBotInc.readMessages([m.key])
            console.log(color(`\n< ================================================== >\n`, 'cyan'))
...
fs.writeFileSync('./lib/database/user.json', JSON.stringify(verifieduser, null, 2))
}

ShadowBotInc.sendPresenceUpdate('unavailable', from)
...
Type *surrender* to surrender and admit defeat`
	    ...
	    if (room13.x !== room13.o) await ShadowBotInc.sendText(room13.x, str, m, { mentions: parseMention(str) } )
	    await ShadowBotInc.sendText(room13.o, str, m, { mentions: parseMention(str) } )
	    if (isTie || isWin) {
	    ...
	    ShadowBotInc.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} rejected the suit, the suit is canceled`, m)
	    ...
	    ShadowBotInc.sendText(m.chat, `Suit has been sent to chat
...
click https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
	    if (!roof.pilih) ShadowBotInc.sendText(roof.p, `Please Select \n\Rock🗿\nPaper📄\nScissors✂️`, m)
	    if (!roof.pilih2) ShadowBotInc.sendText(roof.p2, `Please Select \n\nRock🗿\nPaper📄\nScissors✂️`, m)
	    roof.waktu_milih = setTimeout(() => {
	    if (!roof.pilih && !roof.pilih2) ShadowBotInc.sendText(m.chat, `Both Players Don't Want To Play,\nSuit Canceled`)
	    else if (!roof.pilih || !roof.pilih2) {
	    win = !roof.pilih ? roof.p2 : roof.p
	    ShadowBotInc.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} Didn't Choose Suit, Game Over!`, m)
	    }
	    delete this.suit[roof.id]
	    return !0
	    }, roof.timeout)
	    ...
	    if (!roof.pilih2) ShadowBotInc.sendText(roof.p2, '_The opponent has chosen_\nNow it is your turn', 0)
	    }
	    if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
	    roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
	    roof.text2 = m.text
	    m.reply(`You have chosen ${m.text} ${!roof.pilih ? `\n\nWaiting for the opponent to choose` : ''}`)
	    if (!roof.pilih) ShadowBotInc.sendText(roof.p, '_The opponent has chosen_\nNow it is your turn', 0)
	    }
	    ...
	    ShadowBotInc.sendText(roof.asal, `_*Suit Results*_${tie ? '\nSERIES' : ''}
...
user.afkReason = ''
	...
	if (db.settings[botNumber].autobio) {
		...
		await ShadowBotInc.updateProfileStatus(`${ShadowBotInc.user.name} | Runtime : ${runtime(uptime)}`)
...
if (m.sender.startsWith('212')) return ShadowBotInc.updateBlockStatus(m.sender, 'block')
}

//autokick 212
if (global.autokickmorroco) {
if (m.isGroup && m.sender.startsWith('212')) return ShadowBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
}
...
return await ShadowBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
}

}

async function sendShadowBotIncMessage(chatId, message, options = {}){
    let generate = await generateWAMessage(chatId, message, options)
    let type2 = getContentType(generate.message)
    if ('contextInfo' in options) generate.message[type2].contextInfo = options?.contextInfo
    if ('contextInfo' in message) generate.message[type2].contextInfo = message?.contextInfo
    return await ShadowBotInc.relayMessage(chatId, generate.message, { messageId: generate.key.id })
}
...
ShadowBotInc.sendImageAsSticker(m.chat, pesan, m, { packname: global.packname, author: global.author })
}

const sendvn = (teks) => {
ShadowBotInc.sendMessage(from, { audio: teks, mimetype: 'audio/mp4', ptt: true }, { quoted: m })
}

//autoreply
for (let BhosdikaXeon of VoiceNote) {
if (budy === BhosdikaXeon) {
let audiobuffy = fs.readFileSync(`./Assets/Media2/audio/${BhosdikaXeon}.mp3`)
ShadowBotInc.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaXeon of StickerS){
if (budy === BhosdikaXeon){
let stickerbuffy = fs.readFileSync(`./Assets/Media2/sticker/${BhosdikaXeon}.webp`)
ShadowBotInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of ImageS){
if (budy === BhosdikaXeon){
let imagebuffy = fs.readFileSync(`./Assets/Media2/image/${BhosdikaXeon}.jpg`)
ShadowBotInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of VideoX){
if (budy === BhosdikaXeon){
let videobuffy = fs.readFileSync(`./Assets/Media2/video/${BhosdikaXeon}.mp4`)
ShadowBotInc.sendMessage(m.chat, { video: videobuffy }, { quoted: m })
}
}

if (m.isGroup && m.mtype == 'viewOnceMessage') {
let teks = `╭「 *Anti ViewOnce* 」\n├ *Name* : ${pushname}\n├ *User* : @${m.sender.split("@")[0]}\n├ *Clock* : ${time2}\n└ *Message* : ${m.mtype}`
ShadowBotInc.sendMessage(m.chat, { text: teks, mentions: [m.sender] }, { quoted: m })
await sleep(500)
...
if (command) {
ShadowBotInc.sendPresenceUpdate('composing', from)
}
}
if (global.autoRecord) {
if (command) {
ShadowBotInc.sendPresenceUpdate('recording', from)
}
}
...
let gdyr = await ShadowBotInc.sendMessage(from, {image: { url: Lehd.thumb } , caption: `Channel Name : ${ghed.player_response.videoDetails.author}
...
.on('finish', async () => {
await ShadowBotInc.sendMessage(from, { video: fs.readFileSync(mp4File), caption: mess.succes, gifPlayback: false }, { quoted: gdyr })
...
let gedeyeer = await ShadowBotInc.sendMessage(from, { image: { url: Puxa.thumb } , caption: `Channel Name : ${PlXz.player_response.videoDetails.author}
...
.on('finish', async () => {
await ShadowBotInc.sendMessage(from, { audio: fs.readFileSync(mp3File), mimetype: 'audio/mp4' }, { quoted: gedeyeer })
    ...
    m.reply(`This feature is for premium user, contact the owner to become premium user`)
        ...
        if (isAutoSticker) {
            if (/image/.test(mime) && !/webp/.test(mime)) {
                ...
                await ShadowBotInc.sendImageAsSticker(from, mediac, m, { packname: global.packname, author: global.author })
                console.log(`Auto sticker detected`)
            } else if (/video/.test(mime)) {
                if ((quoted.msg || quoted).seconds > 11) return
                let mediac = await quoted.download()
                await ShadowBotInc.sendVideoAsSticker(from, mediac, m, { packname: global.packname, author: global.author })
            }
        }
...
// Anti Link
        ...
        if (isgclink) return ShadowBotInc.sendMessage(m.chat, {text: `\`\`\`「 Group Link Detected 」\`\`\`\n\nYou won't be kicked by a bot because what you send is a link to this group`})
        if (isAdmins) return ShadowBotInc.sendMessage(m.chat, {text: `\`\`\`「 Group Link Detected 」\`\`\`\n\nAdmin has sent a link, admin is free to post any link`})
        if (ShadowTheCreator) return ShadowBotInc.sendMessage(m.chat, {text: `\`\`\`「 Group Link Detected 」\`\`\`\n\nOwner has sent a link, owner is free to post any link`})
        kice = m.sender
        await ShadowBotInc.sendMessage(m.chat,
			...
			ShadowBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
			ShadowBotInc.sendMessage(from, {text:`\`\`\`「 Group Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending group link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
            }            
        }
...
if (ShadowTheCreator) return m.reply(bvl)
kice = m.sender
        await ShadowBotInc.sendMessage(m.chat,
			    {
			        delete: {
			...
			ShadowBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
ShadowBotInc.sendMessage(from, {text:`\`\`\`「 Wa.me Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending wa.me link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
  if (antiWame)
...
//antivirtex by xeon
  ...
  if (!isBotAdmins) return XeonStickBotAdmin()
          await ShadowBotInc.sendMessage(m.chat,
			...
			ShadowBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
			ShadowBotInc.sendMessage(from, {text:`\`\`\`「 Virus Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending virus in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
  }
  }
//anti bad words by xeon
if (antiToxic)
if (BadX.includes(messagesD)) {
if (m.text) {
...
if (ShadowTheCreator) return m.reply(bvl)
        await ShadowBotInc.sendMessage(m.chat,
			...
			await ShadowBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
ShadowBotInc.sendMessage(from, {text:`\`\`\`「 Bad Word Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} was kicked because of using bad words in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})}
}
...
if (ShadowTheCreator) return m.reply(bvl)
        await ShadowBotInc.sendMessage(m.chat,
			...
			ShadowBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
ShadowBotInc.sendMessage(from, {text:`\`\`\`「 YouTube Video Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending youtube video link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (ShadowTheCreator) return m.reply(bvl)
        await ShadowBotInc.sendMessage(m.chat,
			...
			ShadowBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
ShadowBotInc.sendMessage(from, {text:`\`\`\`「 YouTube Channel Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending youtube channel link in this group`, contextInfo:{mentionedJid:[m.sendet]}}, {quoted:m})
} else {
}
...
if (ShadowTheCreator) return m.reply(bvl)
        await ShadowBotInc.sendMessage(m.chat,
			...
			ShadowBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
ShadowBotInc.sendMessage(from, {text:`\`\`\`「 Instagram Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending instagram link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (ShadowTheCreator) return m.reply(bvl)
        await ShadowBotInc.sendMessage(m.chat,
			...
			ShadowBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
ShadowBotInc.sendMessage(from, {text:`\`\`\`「 Facebook Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending facebook link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (ShadowTheCreator) return m.reply(bvl)
        await ShadowBotInc.sendMessage(m.chat,
			...
			ShadowBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
ShadowBotInc.sendMessage(from, {text:`\`\`\`「 Telegram Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending telegram link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (ShadowTheCreator) return m.reply(bvl)
        await ShadowBotInc.sendMessage(m.chat,
			...
			ShadowBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
ShadowBotInc.sendMessage(from, {text:`\`\`\`「 Tiktok Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending tiktok link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (ShadowTheCreator) return m.reply(bvl)
        await ShadowBotInc.sendMessage(m.chat,
			...
			ShadowBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
ShadowBotInc.sendMessage(from, {text:`\`\`\`「 Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
emoji.get(satu)
.then(emoji => {
ShadowBotInc.sendMessage(from, { caption: mess.success, image: {url: emoji.images[dua].url} }, {quoted:m})
})
} catch (e) {
...
let messages = await generateWAMessage(m.chat, { text: text, mentions: mentionedJid }, {
    userJid: ShadowBotInc.user.id,
    quoted: m.quoted && m.quoted.fakeObj
})
messages.key.fromMe = areJidsSameUser(m.sender, ShadowBotInc.user.id)
...
ShadowBotInc.ev.emit('messages.upsert', msg)
}
...
Type *surrender* to surrender and admit defeat`
            ...
            if (this.game) {
            delete this.game
            ShadowBotInc.sendText(m.chat, `Successfully deleted TicTacToe session`, m)
            } else if (!this.game) {
...
*Hi* @${m.mentionedJid[0].split`@`[0]} *Please type accept to accept or type reject to reject`
            this.suit[id] = {
            chat: await ShadowBotInc.sendText(m.chat, caption, m, { mentions: parseMention(caption) }),
            id: id,
            p: m.sender,
            p2: m.mentionedJid[0],
            status: 'wait',
            waktu: setTimeout(() => {
            if (this.suit[id]) ShadowBotInc.sendText(m.chat, `_Suit time out_`, m)
            delete this.suit[id]
...
case 'rentbotlist': 
try {
let user = [... new Set([...global.conns.filter(ShadowBotInc => ShadowBotInc.user).map(ShadowBotInc => ShadowBotInc.user)])]
te = "*Rentbot List*\n\n"
for (let i of user){
y = await ShadowBotInc.decodeJid(i.id)
te += " × User : @" + y.split("@")[0] + "\n"
te += " × Name : " + i.name + "\n\n"
}
ShadowBotInc.sendMessage(from,{text:te,mentions: [y], },{quoted:m})
} catch (err) {
...
break
case 'owner': {
const repf = await ShadowBotInc.sendMessage(from, { 
contacts: { 
displayName: `${list.length} Contact`, 
contacts: list }, mentions: [sender] }, { quoted: m })
ShadowBotInc.sendMessage(from, { text : `Hi @${sender.split("@")[0]}, Here is my handsome owner😇`, mentions: [sender]}, { quoted: repf })
}
break
case 'alive': case 'panel': case 'list': case 'menu': case 'help': case '?': {
            ...
            xeonezy = ` 
🚀 *${shadowytimewisher} ${pushname} senpai ${global.botname}'s Command Center is ready for action! Check out these cool commands:* 🚀
...
┃ ✗𝗣𝗿𝗲𝗳𝗶𝘅 :  NO-PREFIX 
┃ ✗𝗠𝗼𝗱𝗲 : ${ShadowBotInc.public ? 'Public' : `Self`}
...
case 'sound160':
case 'sound161':
ShadowBotInc_dev = await getBuffer(`https://github.com/DGXeon/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
await ShadowBotInc.sendMessage(m.chat, { audio: ShadowBotInc_dev, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
break
case 'friend':
case 'searchfriend':{
...
setTimeout(() => {
ShadowBotInc.sendMessage(from, {text: `Here @${teman.split("@")[0]}`, mentions: [teman]}, { quoted : m })
}, 9000)
}
break
...
case 'request': case 'reportbug': {
   ...
   m.sender.split("@")[0]
            ...
            for (let i of owner) {
                ShadowBotInc.sendMessage(i + "@s.whatsapp.net", {
                    text: textt + teks1,
                    mentions: [m.sender],
                }, {
                    quoted: m,
...
let xeonquotx= await ShadowBotInc.serializeM(await m.getQuotedObj())
...
await ShadowBotInc.groupAcceptInvite(result)
...
*${prefix}deletevote* - to delete vote`
            ShadowBotInc.sendMessage(m.chat, {text: teks_vote}, {quoted:m})
	    }
            break
               case 'upvote': {
            if (!m.isGroup) return XeonStickGroup()
...
*${prefix}downvote* -  to downvote
*${prefix}deletevote* - to delete vote`
            ShadowBotInc.sendMessage(m.chat, {text: teks_vote, mentions: menvote}, {quoted:m})
	    }
             break
                case 'downvote': {
            if (!m.isGroup) return XeonStickGroup()
...
anuanuan = await ShadowBotInc.downloadAndSaveMediaMessage(quoted)
ShadowBotInc.sendMessage(m.chat, {video: {url:anuanuan}, caption: `Here you go!`, fileLength: "99999999", viewOnce : true},{quoted: m })
}
}
break
case 'fliptext': {
...
break
            case 'listpc': {
                 ...
                 ShadowBotInc.sendTextWithMentions(m.chat, teks, m)
             }
             break
                case 'listgc': {
                 ...
                 for (let i of anulistg) {
                     let metadata = await ShadowBotInc.groupMetadata(i)
            ...
            case 'bctext': case 'broadcasttext': case 'broadcast': {
			    if (!ShadowTheCreator) return XeonStickOwner()
		            if (!q) return replygcxeon(`Enter text`)
                            ...
                            for (let i of data) {
                               ShadowBotInc.sendMessage(i.id, {text: `${ownername}'s Broadcast\n\nMessage : ${q}` })
                               await sleep(1000)
                            }
                            }
                            break
...
await ShadowBotInc.sendMessage(i, { image:media,  caption: txt,mentions:participants.map(a => a.id) })
}
if(/video/.test(mime)){
let media = await quoted.download()
await ShadowBotInc.sendMessage(i, { video:media,  caption: txt, mentions:participants.map(a => a.id) })
}
            }
...
break
            case 'react': {
                ...
                ShadowBotInc.sendMessage(m.chat, reactionMessage)
            }
            break
...
ShadowBotInc.groupSettingUpdate(from, 'not_announcement')
...
var groupe = await ShadowBotInc.groupMetadata(from)
var members = groupe['participants']
var mems = []
members.map(async adm => {
mems.push(adm.id.replace('c.us', 's.whatsapp.net'))
})
ShadowBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nNo body is allowed to send virus in this group, member who send will be kicked immediately!`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
ntnsfw.push(from)
fs.writeFileSync('./lib/database/nsfw.json', JSON.stringify(ntnsfw))
...
fs.writeFileSync('./lib/database/antilinkytvideo.json', JSON.stringify(ntilinkytvid))
...
fs.writeFileSync('./lib/database/antilinkytchannel.json', JSON.stringify(ntilinkytch))
...
ntilinkig.push(from)
fs.writeFileSync('./lib/database/antilinkinstagram.json', JSON.stringify(ntilinkig))
...
ntilinkfb.push(from)
fs.writeFileSync('./lib/database/antilinkfacebook.json', JSON.stringify(ntilinkfb))
...
ntilinktg.push(from)
fs.writeFileSync('./lib/database/antilinktelegram.json', JSON.stringify(ntilinktg))
...
ntilinktt.push(from)
fs.writeFileSync('./lib/database/antilinktiktok.json', JSON.stringify(ntilinktt))
...
fs.writeFileSync('./lib/database/antilinktwitter.json', JSON.stringify(ntilinktwt))
...
ntlinkgc.push(from)
fs.writeFileSync('./lib/database/antilinkgc.json', JSON.stringify(ntlinkgc))
replygcxeon('Success in turning on antiwame in this group')
var groupe = await ShadowBotInc.groupMetadata(from)
var members = groupe['participants']
var mems = []
...
break
           case 'ephemeral': {
                ...
                if (args[0] === 'enable') {
                    ...
                    await ShadowBotInc.sendMessage(m.chat, { disappearingMessagesInChat: false })
                    await replygcxeon(`Done`)
                }
            }
            break
            case 'delete': case 'del': {
                ...
                if (!isBaileys) return replygcxeon('The message was not sent by a bot!')
                 ShadowBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: true, id: m.quoted.id, participant: m.quoted.sender } })
            }
            break
...
var mediz = await ShadowBotInc.downloadAndSaveMediaMessage(quoted, 'ppgc.jpeg')
if (args[0] == `full`) {
var { img } = await generateProfilePicture(mediz)
await ShadowBotInc.query({
tag: 'iq',
attrs: {
to: m.chat,
type:'set',
...
var memeg = await ShadowBotInc.updateProfilePicture(m.chat, { url: mediz })
fs.unlinkSync(mediz)
replygcxeon(`Success`)
}
}
...
ShadowBotInc.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: m })
}
break
case 'ebinary': {
...
case 'remini': {
			...
			ShadowBotInc.sendMessage(m.chat, { image: proses, caption: mess.success}, { quoted: m})
			}
			break
			case 'gimage': {
                ...
                gis(text, async (error, result) => {
                    ...
                    ShadowBotInc.sendMessage(m.chat, { image: { url: images}, caption: `*-------「 GIMAGE SEARCH 」-------*\n🤠 *Query* : ${text}\n🔗 *Media Url* : ${images}`}, { quoted: m })
                })
            }
            case 'gimage': {
...
*❖ Link* : ${baby1[0].link}`
replygcxeon(`${result4}`)
ShadowBotInc.sendMessage(m.chat, { document : { url : baby1[0].link}, fileName : baby1[0].nama, mimetype: baby1[0].mime }, { quoted : m })
}
break
case 'tiktokxx':{ 
...
case 'yts': case 'ytsearch': {
                ...
                ShadowBotInc.sendMessage(m.chat, { image: { url: search.all[0].thumbnail },  caption: teks }, { quoted: m })
            }
            break
case 'xxxxplay':{
if (!text) return replygcxeon(`Example : ${prefix+command} story wa anime`)
...
ShadowBotInc.sendMessage(m.chat, { image : eek, caption: ngen }, { quoted: m})
}
break
case 'play':  case 'song': {
...
BadX.push(q)
fs.writeFileSync('./lib/database/bad.json', JSON.stringify(BadX))
...
VideoX.push(q)
await fsx.copy(delb, `./Assets/Media2/video/${q}.mp4`)
fs.writeFileSync('./Assets/Media2/database/xeonvideo.json', JSON.stringify(VideoX))
fs.unlinkSync(delb)
...
VideoX.splice(wanu, 1)
fs.writeFileSync('./Assets/Media2/database/xeonvideo.json', JSON.stringify(VideoX))
fs.unlinkSync(`./Assets/Media2/video/${q}.mp4`)
...
teks += `┃\n╰━━━━━━━━⊷\n\n*Totally there are : ${VideoX.length}*`
replygcxeon(teks)
}
break
case 'addimage':{
...
let delb = await ShadowBotInc.downloadAndSaveMediaMessage(quoted)
ImageS.push(q)
await fsx.copy(delb, `./Assets/Media2/image/${q}.jpg`)
fs.writeFileSync('./Assets/Media2/database/xeonimage.json', JSON.stringify(ImageS))
fs.unlinkSync(delb)
...
ImageS.splice(wanu, 1)
fs.writeFileSync('./Assets/Media2/database/xeonimage.json', JSON.stringify(ImageS))
fs.unlinkSync(`./Assets/Media2/image/${q}.jpg`)
...
teks += `┃\n╰━━━━━━━━⊷\n\n*Totally there are : ${ImageS.length}*`
replygcxeon(teks)
}
break
case 'addsticker':{
...
let delb = await ShadowBotInc.downloadAndSaveMediaMessage(quoted)
StickerS.push(q)
await fsx.copy(delb, `./Assets/Media2/sticker/${q}.webp`)
fs.writeFileSync('./Assets/Media2/database/xeonsticker.json', JSON.stringify(StickerS))
fs.unlinkSync(delb)
...
fs.writeFileSync('./Assets/Media2/database/xeonsticker.json', JSON.stringify(StickerS))
fs.unlinkSync(`./Assets/Media2/sticker/${q}.webp`)
...
let delb = await ShadowBotInc.downloadAndSaveMediaMessage(quoted)
VoiceNote.push(q)
await fsx.copy(delb, `./Assets/Media2/audio/${q}.mp3`)
fs.writeFileSync('./Assets/Media2/database/xeonvn.json', JSON.stringify(VoiceNote))
fs.unlinkSync(delb)
...
fs.writeFileSync('./Assets/Media2/database/xeonvn.json', JSON.stringify(VoiceNote))
fs.unlinkSync(`./Assets/Media2/audio/${q}.mp3`)
...
teks = '*Premium List*\n\n'
for (let ShadowBotInc of prem) {
teks += `- ${ShadowBotInc}\n`
}
teks += `\n*Total : ${prem.length}*`
ShadowBotInc.sendMessage(m.chat, { text: teks.trim() }, 'extendedTextMessage', { quoted: m, contextInfo: { "mentionedJid": prem } })
break
case 'setcmd': {
...
`.trim()
                ShadowBotInc.sendText(m.chat, teks, m, { mentions: Object.values(global.db.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
            }
            break 
case 'lockcmd': {
...
case 'getmsg': {
                ...
                ShadowBotInc.copyNForward(m.chat, msgs[text.toLowerCase()], true)
            }
            break
case 'listmsg': {
                let msgs = JSON.parse(fs.readFileSync('./lib/database/database.json'))
...
case 'getbio':{
    ...
    let bio = await ShadowBotInc.fetchStatus(who)
...
if (!/image/.test(mime)) return replygcxeon(`Send/Reply Image With Caption ${prefix + command}`)
if (/webp/.test(mime)) return replygcxeon(`Send/Reply Image With Caption ${prefix + command}`)
var medis = await ShadowBotInc.downloadAndSaveMediaMessage(quoted, 'ppbot.jpeg')
if (args[0] == `full`) {
...
var memeg = await ShadowBotInc.updateProfilePicture(botNumber, { url: medis })
fs.unlinkSync(medis)
replygcxeon(`Success`)
}
}
...
let response = await ShadowBotInc.groupInviteCode(cret.id)
teks = `     「 Create Group 」
...
.then(({data}) => {
ShadowBotInc.sendImageAsSticker(from, data.url, m, { packname: global.packname, author: global.author })
})
}
break
case 'woof':
...
case 'tomp4': case 'tovideo': {
                ...
                await ShadowBotInc.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, { quoted: m })
            ...
            ShadowBotInc.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg'}, { quoted : m })
            }
            break
            case 'tomp3': {
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            ShadowBotInc.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${ShadowBotInc.user.name}.mp3`}, { quoted : m })
            }
            break
            ...
            ShadowBotInc.sendMessage(m.chat, {audio: audio, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
            }
            break
            case 'togif': {
		...
		let { webp2mp4File } = require('./lib/uploader')
                let media = await ShadowBotInc.downloadAndSaveMediaMessage(quoted)
                let webpToMp4 = await webp2mp4File(media)
                await ShadowBotInc.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true }, { quoted: m })
                await fs.unlinkSync(media)
            }
            break
            case 'toqr':{
  ...
  await ShadowBotInc.sendMessage(from, { image: medi, caption:"Here you go!"}, { quoted: m })
  ...
  case 'dare':
    ...
    "breakup with your best friend for 5hrs without telling him/her that its a dare",
     ...
     "send abusive words in any grup, excepting this grup, and send screenshot proof here"
              ...
              ShadowBotInc.sendMessage(from, { image: bufferdare, caption: '_You choose DARE_\n'+ xeondare }, {quoted:m})
              break
                            break
       case 'truth':
              const truth =[
    ...
    "do you play pubg, if you then send ur id number"
              ...
              ShadowBotInc.sendMessage(from, { image: buffertruth, caption: '_You choose TRUTH_\n'+ xeontruth }, {quoted:m})
              break
case 'checkme':
					neme = args.join(" ")
					bet = `${sender}`
...
{
        let media = await ShadowBotInc.downloadAndSaveMediaMessage(m.quoted)
        let name = await getRandom('.png')
        exec(`ffmpeg -i ${media} ${name}`, (err) => {
        	fs.unlinkSync(media)
            let buffer = fs.readFileSync(name)
            ShadowBotInc.sendMessage(m.chat, { image: buffer }, { quoted: m })      
fs.unlinkSync(name)
        })
...
ShadowBotInc.downloadAndSaveMediaMessage(quoted, "gifee")
ShadowBotInc.sendMessage(from, {sticker:fs.readFileSync("gifee.webp")},{quoted:m})
} else if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await ShadowBotInc.sendImageAsSticker(m.chat, media, m, { packname: pcknm, author: atnm })
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return replygcxeon('Maximum 10 Seconds!')
let media = await quoted.download()
let encmedia = await ShadowBotInc.sendVideoAsSticker(m.chat, media, m, { packname: pcknm, author: atnm })
} else {
...
case 'qc': case'text': {
    ...
    if (m.quoted) {
      try {
        userPfp = await ShadowBotInc.profilePictureUrl(m.quoted.sender, "image")
      } catch (e) {
        userPfp = defaultpp
      }
    } else {
      try {
        userPfp = await ShadowBotInc.profilePictureUrl(m.sender, "image")
      } catch (e) {
        userPfp = defaultpp
      }
    }
    ...
    try {
      ...
      ShadowBotInc.sendImageAsSticker(m.chat, buffer, m, {
        packname: packname,
        author: author,
      })
    } catch (error) {
...
if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await ShadowBotInc.sendImageAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })

} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return replygcxeon('Send/Reply Images/Videos/Gifs With Captions ${prefix+command}\nVideo Duration 1-9 Seconds')
let media = await quoted.download()
let encmedia = await ShadowBotInc.sendVideoAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
...
ShadowBotInc.sendMessage(from, { text: `*${command}*\n\nName : ${q}\nAnswer : *${teng}%*` }, { quoted: m })
					break
case 'beautifulcheck':
				if (!text) return replygcxeon(`Tag Someone, Example : ${prefix + command} @Xeon`)
...
ShadowBotInc.sendMessage(from, { text: `*${command}*\n\nNama : ${q}\nAnswer : *${tik}%*` }, { quoted: m })
					...
					ShadowBotInc.sendMessage(from, { text: `Character Check : ${q}\nAnswer : *${taky}*` }, { quoted: m })
				     break
case 'awesomecheck':
  case 'greatcheck':
    case 'gaycheck':
...
if (mentionByReply) {
ShadowBotInc.sendMessage(from, { text: 'Question : *' + cex + '*\nChecker : ' + `@${mentionByReply.split('@')[0]}` + '\nAnswer : ' + cek2 + '%', mentions: [mentionByReply] }, { quoted: m })
...
ShadowBotInc.sendMessage(m.chat, { image: { url: anu }, caption: `${mess.success}` }, { quoted: m })
}
break
case 'glitchtext':
case 'writetext':
...
ShadowBotInc.sendMessage(m.chat, { image: { url: haldwhd }, caption: `${mess.success}` }, { quoted: m })
}
break
case 'shadow': 
case 'write': 
...
ShadowBotInc.sendMessage(m.chat, { image: { url: dehe }, caption: `${mess.success}` }, { quoted: m })
}
break
case 'pornhub':{
...
console.log(anuphub)
ShadowBotInc.sendMessage(from,{image:{url:anuphub}, caption:"Here you go!"},{quoted:m})
}
break
case 'retro':{
if(!q) return replygcxeon(`Example: ${prefix + command} ajg | ea`)
...
console.log(anutro2)
ShadowBotInc.sendMessage(from,{image:{url:anutro2}, caption:"Here you go!"},{quoted:m})
}
break
case '8bit':{
if(!q) return replygcxeon(`Example: ${prefix + command} ajg | ea`)
...
console.log(anubit8)
ShadowBotInc.sendMessage(from,{image:{url:anubit8}, caption:"Here you go!"},{quoted:m})
}
break
case 'batman':
...
case 'animewallpaper2': case 'animewall2': {
		...
		let { wallpaper } = require('./lib/scraperW')
                ...
                ShadowBotInc.sendMessage(m.chat, { caption: `Title : ${result.title}\nCategory : ${result.type}\nDetail : ${result.source}\nMedia Url : ${result.image[2] || result.image[1] || result.image[0]}`, image: { url: result.image[0] } } , { quoted: m })
            }
            break
...
ShadowBotInc.sendMessage(m.chat, { image: { url: yeha }, caption : mess.success }, { quoted: m })
}
break
case '>':
case '=>':
...
case 'pushcontact': {
    ...
    for (let pler of mem) {
    ShadowBotInc.sendMessage(pler, { text: q})
     }  
     replygcxeon(`Done`)
      }
      break
...
ShadowBotInc.sendMessage(`${mem.id.split('@')[0]}` + "@s.whatsapp.net", { text: q.split("|")[1] })
await sleep(5000)
}
replygcxeon(`Success`)
}
break
    ...
    break
		...
		for (let res of anumojimix.results) {
		    let encmedia = await ShadowBotInc.sendImageAsSticker(m.chat, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
...
if (!AntiNsfw) return replygcxeon(mess.nsfw)
                ...
                ShadowBotInc.sendMessage(m.chat, { video: { url: result912.video_1 }, caption: `${themeemoji} Title : ${result912.title}\n${themeemoji} Category : ${result912.category}\n${themeemoji} Mimetype : ${result912.type}\n${themeemoji} Views : ${result912.views_count}\n${themeemoji} Shares : ${result912.share_count}\n${themeemoji} Source : ${result912.link}\n${themeemoji} Media Url : ${result912.video_1}` }, { quoted: m })
            }
            break
case 'trap' :
if (!m.isGroup) return XeonStickGroup()
...
XeonStickWait()
  let assss = await axios.get ("https://api.waifu.pics/nsfw/blowjob")
    ...
    await ShadowBotInc.sendMessage(m.chat,{video:bogif, gifPlayback:true },{quoted:m}).catch(err => {
    })
    break
case 'gifhentai':
if (!m.isGroup) return XeonStickGroup()
...
let mese = await ShadowBotInc.sendMessage(m.chat, {image:{url:emoji.images[4].url}, caption: `Made by ${global.botname}`}, {quoted:m})
await ShadowBotInc.sendMessage(from, {text:"reply #s to this image to make sticker"}, {quoted:mese})
})
}
break
case 'volume': {
if (!args.join(" ")) return replygcxeon(`Example: ${prefix + command} 10`)
media = await ShadowBotInc.downloadAndSaveMediaMessage(quoted, "volume")
if (isQuotedAudio) {
rname = getRandom('.mp3')
...
let regex1 = /(?:https|git)(?::\/\/|@)github\.com[\/:]([^\/:]+)\/(.+)/i
    ...
    ShadowBotInc.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: m }).catch((err) => replygcxeon(mess.error))
break
case "spotify":{
if (!isPrem) return replyprem(mess.premium)
if (!text) return replygcxeon(`Where is the link?`)
       ...
       const response = await ShadowBotInc.sendMessage(m.chat, { image: { url: cover_url }, caption: details }, { quoted: m })
        const bufferpotify = await spotify.download()
        await ShadowBotInc.sendMessage(m.chat, { audio: bufferpotify }, { quoted: response })
        }
break
case 'bass': case 'blown': case 'deep': case 'earrape': case 'fast': case 'fat': case 'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'squirrel':
                ...
                ShadowBotInc.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : m })
                fs.unlinkSync(ran)
                })
...
*${themeemoji} Example:* ${targetfine.data.list[0].example
    .replace(/\[/g, "")
    .replace(/\]/g, "")}`
   ShadowBotInc.sendMessage(m.chat,{text:reply},{quoted:m})
} catch (err) {
    console.log(err)
...
{ quoted: m})        
            ...
            break
                ...
                ShadowBotInc.sendMessage(m.chat, {caption: mess.success, image: { url: 'https://coffee.alexflipnote.dev/random' }}, { quoted: m })
            }
            break
            case 'wallpaper': {
		...
		let { wallpaper } = require('./lib/scraper')
                ...
                ShadowBotInc.sendMessage(m.chat, {caption: `${themeemoji} Title : ${result.title}\n${themeemoji} Category : ${result.type}\n${themeemoji} Detail : ${result.source}\n${themeemoji} Media Url : ${result.image[2] || result.image[1] || result.image[0]}`, image: { url: result.image[0] }} , { quoted: m })
            }
            break
            case 'wikimedia': {
                if (!text) return replygcxeon('Enter Query Title')
...
└────────────`
     await ShadowBotInc.sendMessage(m.chat, {image: { url: res.profilePic }, caption: te }, {quoted: m})
      } catch {
...
if (!text) return replygcxeon('Where is the text?')
            ...
            return ShadowBotInc.sendMessage(m.chat, {
                audio: {
                    url: xeonrl,
                },
                mimetype: 'audio/mp4',
...
case 'myip': {
        ...
        case 'mathquiz': case 'math': {
                ...
                ShadowBotInc.sendText(m.chat, `*What is the result of: ${result.soal.toLowerCase()}*?\n\nTime: ${(result.waktu / 1000).toFixed(2)} second`, m).then(() => {
...
▢ *Size:* ${res.fileSize}
▢ *Type:* ${res.mimetype}`)
	ShadowBotInc.sendMessage(m.chat, { document: { url: res.downloadUrl }, fileName: res.fileName, mimetype: res.mimetype }, { quoted: m })
   } catch {
...
let group = m.chat
let link = 'https://chat.whatsapp.com/' + await ShadowBotInc.groupInviteCode(group)
      await ShadowBotInc.sendMessage(text+'@s.whatsapp.net', {text: `≡ *GROUP INVITATION*\n\nA user invites you to join this group \n\n${link}`, mentions: [m.sender]})
...
ShadowBotInc.sendMessage(m.chat, { image: { url: result }, caption: '⭔ Media Url : '+result }, { quoted: m })
}
break
case 'ringtone': {
		...
		ShadowBotInc.sendMessage(m.chat, { audio: { url: result.audio }, fileName: result.title+'.mp3', mimetype: 'audio/mpeg' }, { quoted: m })
	    }
	    break
	case 'genshin':
...
await ShadowBotInc.sendMessage(m.chat,{image:{url:urll}, caption:txt},{quoted:m})
} catch (err) {
console.log(err)
...
encmedia = await ShadowBotInc.sendImageAsSticker(from, wifegerakx, m, { packname: global.packname, author: global.author, })
}
break
case 'dogesticker':
case 'dogestick':
...
❄ *Description:* ${anime.synopsis}*`
                await ShadowBotInc.sendMessage(m.chat,{image:{url:anime.picture}, caption:animetxt},{quoted:m})
                }
                break
                case 'imdb':
...
var inputnumber = text.split(" ")[0]
        ...
        for (let i = 0; i < randomxx; i++) {
            ...
            var anu = await ShadowBotInc.onWhatsApp(`${number0}${i}${number1}@s.whatsapp.net`)
            var anuu = anu.length !== 0 ? anu : false
            try {
                try {
                    var anu1 = await ShadowBotInc.fetchStatus(anu[0].jid)
                } catch {
                    var anu1 = '401'
                }
...
case "resetotp": {
if (Input) {
let cekno = await ShadowBotInc.onWhatsApp(Input)
...
ShadowBotInc.copyNForward(m.chat, msgs[budy.toLowerCase()], true)
}
}
